...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btTomaFoto = findViewById<Button>(R.id.btTomaFoto)
        val btSeleccionFoto = findViewById<Button>(R.id.btSeleccionFoto)

        ivFoto = findViewById(R.id.ivFoto)

        /*Referencia de clase fotos*/
        fotos = Fotos(this, ivFoto!!)

        btTomaFoto.setOnClickListener {
            //tomarFoto()
            fotos?.tomarFoto()
        }

        btSeleccionFoto.setOnClickListener {
            //seleccionarFoto()
